...
public:
	...
	DEFINE_MEMBER_FN(GetBaseExtraList, BaseExtraList*, 0x004758F0, UInt32 unk0);//objDesc->sub_4758F0(0);
	DEFINE_MEMBER_FN(Unk001, bool, 0x00475970, UInt32 unk0);//objDesc->sub_475970(61)
